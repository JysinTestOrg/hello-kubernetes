...
code=$(curl GET https://github.com/login/oauth/authorize?client_id=9e4fedaa995f29228ee)
...
response=$(curl X GET -H Authorization: token $access_code https://api.github.com/repos/Josh-01/hello-kubernetes/actions/secrets)
